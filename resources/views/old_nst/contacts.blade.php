          ...
          <div class="grid_12">
            <div class="wrap pad-3">
                <div class="block-5">
                    ...
                    <br><dl>
					<dd>
                        <dt><dd><span>Adresse:</span> N° 97 Rue Araar,<br>Etage 3, Mers Sultan.<br> Casablanca - Maroc</dd></dt>
                ...
                <div class="block-6">
                  ...
                  <a href="#" class="button" onClick="document.getElementById('form').reset()">Effacer</a><a href="khalidzouine@gmail.com" class="button" onClick="document.getElementById('form').submit()"><!--"document.getElementById('form').submit()"-->Envoyer</a></div>
                 </form>
...
mail("khalidzouine@gmail.com", "sujet du courrier", $message, "From: '.$expediteur.'") ; 
} 
> 