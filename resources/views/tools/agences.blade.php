...
<!-- /.modal 3-->
<div class="modal fade bs-example-modal-sm" id="confirmbox" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="mySmallModalLabel">confimer</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body" id="confirm_content"> content will be here </div>
    ...
    <script>
        ...
        function init() {
            ...
            for (let ind = 0; ind < jsonData.agences.length; ind++) {
                ...
                $('#bodytab').append("<div class=\"col-12 \" id=\"card" + ind + "\">" +
                    ...
                    "<button class=\"btn waves-effect waves-light btn-inverse\" style=\"margin-right: 10px\" onclick=\"pass_change(" + jsonData.chefs[ind].id + ")\">Générer mot de passe</button>" +
                    "</div>" +
                    "</div>" +
                    "</div>" +
                    "</div>" +
        ...
        function delet_prod(id_a, id_p, place) {
            ...
            $('#confirmfooter').html("<button type=\"button\" class=\"btn btn-danger\" id=\"delet_confirm\">confirmer</button>");
            $('#confirm_content').html("<b> Voulez-vous vraiment suprimer ce produit ?</b>");
            $('#confirmbox').modal('show');
            $('#delet_confirm').click(function() {
                var inputs = {
                    "agence": id_a,
                    "produit": id_p
                };
